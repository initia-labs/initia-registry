...
const assets: AssetList[] = [_zaar.assets,_nuwarollup.assets,_miniwasm.assets,_minimove.assets,_minievm.assets,_milkyway.assets,_infinityg.assets,_inertia_legacy.assets,_embr.assets,_culinaris.assets];
