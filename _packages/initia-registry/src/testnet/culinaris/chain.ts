...
const info: Chain = {
  ...
  "explorers": [
    {
      ...
      "account_page": "https://scan.testnet.initia.xyz/culinaris-2/accounts/${accountAddress}"
    }
  ],
  "images": [
    {
  ...
  "metadata": {
    ...
    "executor_uri": "https://maze-api-opinit-b53886e8-ebca-41a5-8dd7-64884b25fb2c.ane1-prod-nocsm.newmetric.xyz",
    "ibc_channels": [
      {
    ...
    "assetlist": "https://raw.githubusercontent.com/initia-labs/initia-registry/main/testnets/culinaris/assetlist.json",
    "minitia": {
      "type": "minievm",
      "version": "v0.6.9"
    }
