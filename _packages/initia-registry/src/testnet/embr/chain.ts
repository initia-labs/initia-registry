...
const info: Chain = {
  ...
  "explorers": [
    {
      ...
      "account_page": "https://scan.testnet.initia.xyz/embr-1/accounts/${accountAddress}"
    }
  ],
  "images": [
    {
  ...
  "metadata": {
    ...
    "assetlist": "https://raw.githubusercontent.com/initia-labs/initia-registry/main/testnets/embr/assetlist.json",
    "minitia": {
      "type": "minievm",
      "version": "v0.6.9"
    }
