...
const info: Chain = {
  ...
  "explorers": [
    {
      ...
      "account_page": "https://scan.testnet.initia.xyz/rave-test4/accounts/${accountAddress}"
    }
  ],
  "images": [
    {
  ...
  "metadata": {
    ...
    "assetlist": "https://raw.githubusercontent.com/initia-labs/initia-registry/main/testnets/rave/assetlist.json",
    "minitia": {
      "type": "minievm",
      "version": "v0.5.5"
    }
