...
const info: Chain = {
  ...
  "explorers": [
    {
      ...
      "account_page": "https://scan.testnet.initia.xyz/glados-4/accounts/${accountAddress}"
    }
  ],
  "images": [
    {
  ...
  "metadata": {
    ...
    "assetlist": "https://raw.githubusercontent.com/initia-labs/initia-registry/main/testnets/milkyway/assetlist.json",
    "minitia": {
      "type": "miniwasm",
      "version": "v0.5.4"
    }
