...
const info: Chain = {
  ...
  "apis": {
    ...
    "json-rpc": [
      ...
      {
        "address": "https://jsonrpc-0-infinityg-1.anvil.asia-southeast.initia.xyz"
      },
      {
        "address": "https://jsonrpc-1-infinityg-1.anvil.asia-southeast.initia.xyz"
      }
    ],
    "json-rpc-websocket": [
      {
      ...
      {
        "address": "wss://jsonrpc-ws-0-infinityg-1.anvil.asia-southeast.initia.xyz"
      },
      {
        "address": "wss://jsonrpc-ws-1-infinityg-1.anvil.asia-southeast.initia.xyz"
      }
    ]
  },
  "key_algos": [
  ...
  "explorers": [
    {
      ...
      "account_page": "https://scan.testnet.initia.xyz/infinityg-1/accounts/${accountAddress}"
    }
  ],
  "images": [
    {
  ...
  "metadata": {
    ...
    "executor_uri": "https://opinit-api-infinityg-1.anvil.asia-southeast.initia.xyz",
    "ibc_channels": [
      {
    ...
    "assetlist": "https://raw.githubusercontent.com/initia-labs/initia-registry/main/testnets/infinityg/assetlist.json",
    "minitia": {
      "type": "minievm",
      "version": "v0.7.2-1"
    }
