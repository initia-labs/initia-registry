...
const chains: Chain[] = [_zaar.chain,_yominet.chain,_rave.chain,_nuwarollup.chain,_miniwasm.chain,_minimove.chain,_minievm.chain,_milkyway.chain,_intergaze.chain,_initia.chain,_infinityg.chain,_inertia_legacy.chain,_inertia.chain,_embr.chain,_echelon.chain,_culinaris.chain,_civitia.chain];
