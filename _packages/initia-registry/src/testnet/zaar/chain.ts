...
const info: Chain = {
  ...
  "apis": {
    ...
    "json-rpc": [
      {
        "address": "https://jsonrpc-zaar-testnet-5.anvil.asia-southeast.initia.xyz"
      }
    ],
    "json-rpc-websocket": [
      {
        "address": "wss://jsonrpc-ws-zaar-testnet-5.anvil.asia-southeast.initia.xyz"
      }
    ]
  },
  "explorers": [
    {
      ...
      "account_page": "https://scan.testnet.initia.xyz/zaar-testnet-5/accounts/${accountAddress}"
    }
  ],
  "images": [
    {
  ...
  "metadata": {
    ...
    "executor_uri": "https://opinit-api-zaar-testnet-5.anvil.asia-southeast.initia.xyz",
    "ibc_channels": [
      {
    ...
    "assetlist": "https://raw.githubusercontent.com/initia-labs/initia-registry/main/testnets/zaar/assetlist.json",
    "minitia": {
      "type": "minievm",
      "version": "v0.6.9"
    }
