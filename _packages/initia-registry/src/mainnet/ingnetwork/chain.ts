...
const info: Chain = {
  ...
  fees: {
    fee_tokens: [
      {
        denom:
          "l2/4daa1ce1a1956bf454f4a22bd6ecc7932737c88e1c3868dcd208684e0d432009",
  ...
  metadata: {
    ...
    assetlist:
      "https://raw.githubusercontent.com/initia-labs/initia-registry/main/mainnets/ingnetwork/assetlist.json",
    minitia: {
      type: "minievm",
      version: "v1.0.3",
    },
